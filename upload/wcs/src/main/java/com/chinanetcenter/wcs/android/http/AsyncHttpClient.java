 ...
 * SimpleRequestParams} instance, and responses can be handled by passing an anonymously overridden {@link
 * com.chinanetcenter.wcs.android.http.ResponseHandlerInterface} instance. <p>&nbsp;</p> For example: <p>&nbsp;</p>
 * <pre>
...
//    private int timeout = DEFAULT_SOCKET_TIMEOUT;
    ...
    private static SchemeRegistry getDefaultSchemeRegistry(boolean fixNoHttpResponseException, int httpPort, int httpsPort) {
        if (fixNoHttpResponseException) {
            WCSLogUtil.d("Beware! Using the fix is insecure, as it doesn't verify SSL certificates.");
        }

        if (httpPort < 1) {
            httpPort = 80;
            WCSLogUtil.d("Invalid HTTP port number specified, defaulting to 80");
        }

        if (httpsPort < 1) {
            httpsPort = 443;
            WCSLogUtil.d("Invalid HTTPS port number specified, defaulting to 443");
        }
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        HttpProtocolParams.setUserAgent(httpParams, String.format("WCSSDK /%s (http://wcs.chinanetcenter.com/)", Config.VERSION));
...
//    }
    ...
    public void cancelRequests(Context context, String tag, boolean mayInterruptIfRunning) {
        List<RequestHandle> requestList = requestMap.get(context);
        if (requestList != null) {
        	List<RequestHandle> cancelledHandle = new LinkedList<RequestHandle>();
            for (RequestHandle requestHandle : requestList) {
            	boolean shouldCancel = tag == null;
            	if (!shouldCancel) {
            		shouldCancel = tag.equals(requestHandle.getTag());
            	}
            	if (shouldCancel) {
            		requestHandle.cancel(mayInterruptIfRunning);
            		cancelledHandle.add(requestHandle);
            	}
            }
            requestList.removeAll(cancelledHandle);
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle head(String url, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle head(Context context, String url, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle head(Context context, String url, Header[] headers, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(String url, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Context context, String url, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Context context, String url, Header[] headers, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(String url, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(Context context, String url, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(Context context, String url, Header[] headers, SimpleRequestParams params, String contentType,
    ...
    public RequestHandle post(Context context, String url, Header[] headers, HttpEntity entity, String contentType,
    		ResponseHandlerInterface responseHandler, String tag) {
    	HttpEntityEnclosingRequestBase request = addEntityToRequestBase(new HttpPost(url), entity);
    	if (headers != null) request.setHeaders(headers);
    	return sendRequest(httpClient, httpContext, request, contentType, responseHandler, context, tag);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle put(String url, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle put(Context context, String url, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle delete(Context context, String url, Header[] headers, SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
    ...
    protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context, String tag) {
        if (contentType != null) {
        ...
        RequestHandle requestHandle = new RequestHandle(request, tag);
     ...
     * @param params          SimpleRequestParams to be appended on the end of URL
     * @param shouldEncodeUrl whether url should be encoded (replaces spaces with %20)
     * @return encoded url if requested with params appended if any available
     */
    public static String getUrlWithQueryString(boolean shouldEncodeUrl, String url, SimpleRequestParams params) {
        if (shouldEncodeUrl)
            url = url.replace(" ", "%20");
        ...
        WCSLogUtil.d("final get url : " + url);
        return url;
    }

    /**
     * Returns HttpEntity containing data from SimpleRequestParams included with request declaration.
     ...
     */
    private HttpEntity paramsToEntity(SimpleRequestParams params, ResponseHandlerInterface responseHandler) {
